...
class MuMaterial
{
	...
	**/
	 ...
	 *
	 * @return
	 * bool - true if voice exists inside material
	 * 
	 **/
	 ...
	 * 
	 **/	
	void SetVoice(int voiceNumber, MuMaterial inMaterial, int inVoice);
	 ...
	 *
	 **/			
	void Mix( MuMaterial inMaterial);
	 ...
	 *
	 **/			
	void Mix(int voiceNumber, MuMaterial inMaterial, int inVoice);
	 ...
	 *
	 **/			
	void Append(int voiceNumber, MuMaterial inMaterial, int inVoice);
