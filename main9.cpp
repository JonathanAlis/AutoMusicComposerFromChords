...
//inicio da criação da melodia
	...
	//a primeira tem peso 3, a segunda tem peso 1, a terceira peso 2 e a ultima peso 2.
		...
		case 1:
		case 2:
		case 3: nota.SetDur(dur1(PertenceAoAcorde,rapido, melodia.GetVoice(0).Dur()));break;
...
{if(rapido)return (1.0+PertenceAoAcorde)/(rapido*4);
return 2*(1.0+PertenceAoAcorde)/((2*Between(1,2)));
}
